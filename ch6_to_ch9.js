...
let noOfsubj = 3;
let total = 100;
let allSubMarks = total * noOfsubj;
const totalMarks = 100 * noOfsubj;
let pereng = parseInt(((english) / total) * 100);
let permath = parseInt(((maths) / total) * 100);
let perurdu = parseInt(((urdu) / total) * 100);
let totalPer = parseInt(((english + maths + urdu) / totalMarks ) * 100);
